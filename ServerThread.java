    ...
    private static class ConnectionHandler implements Runnable {
        ...
        private void handleFileListRequest() {
            try {
                ...
                // Use FileManager to send our file list
                FileManager.sendFileList(clientSocket);
        ...
        private void handleFileDownloadRequest(BufferedReader in) {
            try {
                ...
                List<String> availableFiles = FileManager.getAvailableFiles();
                ...
                boolean success = FileManager.sendFile(fileName, clientSocket);
