 ...
 */
public class ClientHandlerClean {
     ...
     */
    public ClientHandlerClean(String peerIP, int peerPort) {
        this.peerIP = peerIP;
    ...
    public List<String> requestFileList() {
        ...
        try {
            ...
            // Receive file list using FileManagerClean
            List<String> files = FileManagerClean.receiveFileList(socket);
    ...
    public boolean downloadFile(String fileName) {
        ...
        try {
            ...
            boolean success = FileManagerClean.receiveFile(fileName, socket);
